...
async def send_help(message: Message):
    try:
        await message.reply(f"Findplant - бот для удобной работы с ИИ.\n"
                            "Доступ к Chat GPT 4 + ваша картотека промптов.\n"
                            "🎁 Демо-версия - до 10 запросов в сутки.\n"
                            "💰 Платная версия - до 50 запросов в сутки. Стоимость - 99 рублей в месяц.\n"
                            "Команды:\n"
                            "🛒 /buy - купить подписку\n"
                            "📚 /prompts - показать мои промпты\n"
                            "➕ /add - добавить новый промпт\n"
                            "✏️ /edit - редактировать промпт\n"
                            "❌ /delete - удалить промпт\n"
                            "↩️ /cancel - отменить команду")
    except Exception as e:
